...
if __name__ == '__main__':
    ...
    ##### Init #####
    # Input files
    adp_path = r"X:\GIS\GIS DATA\GRB\GRB-ADP_AdministratievePercelen\GRB ADP (toestand 12-02-2019)\Shapefile\Adp.shp"
    gbg_path = r"X:\GIS\GIS DATA\GRB\GRB2019 (toestand 2019-05-20)\gbg.gpkg"
