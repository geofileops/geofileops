...
def test_has_layer_styles(tmp_path):
    test_path = test_helper.get_testfile("polygon-parcel", dst_dir=tmp_path)

    assert not gfo._has_layerstyles_table(test_path)
    gfo._init_layerstyles(test_path)
    assert gfo._has_layerstyles_table(test_path)


def test_add_remove_layer_style(tmp_path):
    test_path = test_helper.get_testfile("polygon-parcel", dst_dir=tmp_path)
    ...
    qml = '''<!DOCTYPE qgis PUBLIC "http://mrcc.com/qgis.dtd" "SYSTEM">
        ...
        <temporal limitMode="0" durationField="" accumulate="0" enabled="0" startExpression="" endExpression="" startField="" fixedDuration="0" mode="0" endField="" durationUnit="min">
        <fixedRange>
        <start></start>
        <end></end>
        </fixedRange>
        ...
        <symbol name="0" clip_to_extent="1" force_rhr="0" type="fill" alpha="1">
            ...
            <Option name="color" value="12,246,0,255" type="QString"/>
            ...
            <Option type="Map">
                ...
                <Option name="line_color" value="12,246,0,255" type="QString"/>
            ...
            <prop k="line_color" v="12,246,0,255"/>
        ...
        <DiagramCategory width="15" enabled="0" penAlpha="255" backgroundColor="#ffffff" lineSizeScale="3x:0,0,0,0,0,0" spacing="5" minimumSize="0" penWidth="0" scaleBasedVisibility="0" barWidth="5" labelPlacementMethod="XHeight" direction="0" backgroundAlpha="255" height="15" sizeScale="3x:0,0,0,0,0,0" showAxis="1" spacingUnitScale="3x:0,0,0,0,0,0" diagramOrientation="Up" penColor="#000000" opacity="1" minScaleDenominator="0" spacingUnit="MM" scaleDependency="Area" rotationOffset="270" lineSizeType="MM" sizeType="MM" maxScaleDenominator="1e+08">
        ...
        <DiagramLayerSettings placement="1" priority="0" obstacle="0" showAll="1" linePlacementFlags="18" zIndex="0" dist="0">
        <properties>
        <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <field name="classname" configurationFlags="None">
        <editWidget type="TextEdit">
            <config>
            <Option/>
            </config>
        ...
        <alias name="" index="1" field="classname"/>
        </aliases>
        <defaults>
        <default applyOnUpdate="0" field="fid" expression=""/>
        <default applyOnUpdate="0" field="classname" expression=""/>
        </defaults>
        <constraints>
        <constraint unique_strength="1" exp_strength="0" notnull_strength="1" field="fid" constraints="3"/>
        <constraint unique_strength="0" exp_strength="0" notnull_strength="0" field="classname" constraints="0"/>
        </constraints>
        <constraintExpressions>
        <constraint exp="" desc="" field="fid"/>
        <constraint exp="" desc="" field="classname"/>
        </constraintExpressions>
        <expressionfields/>
        <attributeactions>
        ...
        <column name="classname" type="field" hidden="0" width="-1"/>
        ...
        <editable>
        <field name="classname" editable="1"/>
        <field name="fid" editable="1"/>
        </editable>
        <labelOnTop>
        <field name="classname" labelOnTop="0"/>
        <field name="fid" labelOnTop="0"/>
        </labelOnTop>
        <reuseLastValue>
        <field reuseLastValue="0" name="classname"/>
        <field reuseLastValue="0" name="fid"/>
        </reuseLastValue>
        <dataDefinedFieldProperties/>
        <widgets/>
        <previewExpression>"classname"</previewExpression>
        <mapTip></mapTip>
...
def test_get_layer_styles(tmp_path):
    test_path = test_helper.get_testfile("polygon-parcel", dst_dir=tmp_path)
    gfo._init_layerstyles(test_path)
