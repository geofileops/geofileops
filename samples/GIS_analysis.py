...
if __name__ == "__main__":
    ...
    buildings_diss_buf100m_diss_path = str(
        output_dir / f"{output_basename}_diss_buf100m_diss.gpkg"
    )
    gfo.dissolve(
    ...
    logger.info(
        f"Processing ready, total time was {datetime.datetime.now()-start_time}!"
    )
